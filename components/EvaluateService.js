...
import { StyleSheet, View, Text, SafeAreaView, TextInput, TouchableOpacity, ImageBackground, Keyboard, Image, TouchableWithoutFeedback } from 'react-native';
    ...
    <View style={styles.container}>
      ...
      <View style={styles.blurContainer}>
        ...
        <View style={{ alignItems: 'center' }}>
          <Text style={styles.bold_text}>Насколько вы довольны</Text>
          <Text style={styles.bold_text}>качеством обслуживания?</Text>
        </View>
        <LinearGradient
