import { ActivityIndicator, StyleSheet, View, Text, Image, SafeAreaView, TextInput, TouchableOpacity, ImageBackground, ScrollView } from 'react-native';
            ...
            return (<View key={obj.id}>
              <TouchableOpacity activeOpacity={0.7} onPress={() => clickStock(obj.id)} style={styles.margin_TouchOpac}>
                <View style={styles.row}>
                  ...
                  {selectStock.indexOf(obj.id) != -1 && <FontAwesome5 name='check' size={28} color={'#7CD0D7'} />}
                </View>
              </TouchableOpacity>
