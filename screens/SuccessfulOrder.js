...
import { Image, ImageBackground, SafeAreaView, StyleSheet, Text, TextInput, TouchableOpacity, View, Button } from 'react-native'
  ...
  return (
    <SafeAreaView style={styles.container} >
      <View style={styles.main}>
        ...
        <TouchableOpacity activeOpacity={0.8} onPress={() => navigation.navigate('PersonalAccount')} style={styles.mt} >
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Map')} activeOpacity={0.7} style={styles.mt}>
